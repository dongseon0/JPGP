...
public class BlackHumanSpawner : MonoBehaviour
{
    public GameObject blackHumanPrefab;     // Black 인간 프리팹
    ...
    void Update()
    {
        ...
        if (timer >= spawnInterval)
        {
            ...
            if (currentCount < maxCount)
            {
                ...
                Instantiate(blackHumanPrefab, spawnPos, blackHumanPrefab.transform.rotation);
